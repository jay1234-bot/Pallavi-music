...
# --------------------------------------------------------
BOT_USERNAME = getenv("BOT_USERNAME" , "NETFLIX_MUSICXZ_BOT")
# --------------------------------------------------------
BOT_NAME = getenv("BOT_NAME" , "NETFLIX MUSIC")
# ---------------------------------------------------------
ASSUSERNAME = getenv("ASSUSERNAME" , "PHYSCO_HU_BABY")
# ---------------------------------------------------------
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/MTSTUDIO84/Pallavi-music",
)
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://files.catbox.moe/6trbtj.jpg"
)
PING_IMG_URL = getenv(
    "PING_IMG_URL", "https://files.catbox.moe/6trbtj.jpg"
)
PLAYLIST_IMG_URL = "https://files.catbox.moe/6trbtj.jpg"
...
STREAM_IMG_URL = "https://files.catbox.moe/6trbtj.jpg"
SOUNCLOUD_IMG_URL = "https://files.catbox.moe/2vq8oz.jpg"
YOUTUBE_IMG_URL = "https://files.catbox.moe/6trbtj.jpg"
